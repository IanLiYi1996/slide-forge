...
interface SlidesRequest {
  ...
  templateId?: string; // Selected presentation template
...
export async function POST(req: Request) {
  try {
    ...
    // Combine template system prompt with default slide structure
    const templateSystemPrompt = `${template.systemPrompt}
...
${template.slideStructure}`;
    ...
    // Prepend template-specific instructions
    const finalPrompt = `${templateSystemPrompt}
